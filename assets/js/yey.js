				...
				const obj = {
					...
					cordova:{
						...
						localStorage :{
							...
							updateDb : function(){
								...
								//hapus rate
								if( obj.dataStorage.rate ) delete obj.dataStorage.rate;
								
								
								//ubah ke rateApp
								if( !obj.dataStorage.rateApp ){
									
									obj.dataStorage.rateApp = {
					...
					modal : {
						...
						appRate : function(){
							...
							datePlusOneDay = new Date( dateFirstRecord )
							dateNow = new Date(),
							...
							if( !dataState && datePlusOneDay < dateNow  ){
